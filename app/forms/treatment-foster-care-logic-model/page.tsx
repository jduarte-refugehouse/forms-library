...
import LogicModel from "@/components/treatment-foster-care-logic-model-diagram"
import { PDFExportButton } from "@/components/pdf-export-button"

export default function TreatmentFosterCareLogicModelPage() {
      ...
      <div className="bg-gradient-to-r from-[#5E3989] to-[#A90533] text-white">
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <PDFExportButton
              formTitle="TFFC Logic Model"
              formPath="/forms/treatment-foster-care-logic-model"
