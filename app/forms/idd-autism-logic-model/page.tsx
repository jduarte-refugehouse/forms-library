...
import { IddAutismLogicModelDiagram } from "@/components/idd-autism-logic-model-diagram"

export default function IddAutismLogicModelPage() {
  return (
