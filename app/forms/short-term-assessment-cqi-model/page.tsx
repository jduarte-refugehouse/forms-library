...
import CQICycle from "@/components/short-term-assessment-cqi-cycle-diagram"
import { PDFExportButton } from "@/components/pdf-export-button"

export default function ShortTermAssessmentCQIModelPage() {
      ...
      <div className="bg-gradient-to-r from-[#5E3989] to-[#A90533] text-white">
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <PDFExportButton
              formTitle="STASS CQI Model"
              formPath="/forms/short-term-assessment-cqi-model"
