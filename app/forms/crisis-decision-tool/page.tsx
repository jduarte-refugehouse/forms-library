              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-yellow-50 rounded-lg">
                    <h4 className="font-semibold text-yellow-800 mb-2">Regulatory Compliance:</h4>
                    <div className="text-sm space-y-1">
                      <p>✓ Incident time: {new Date().toLocaleString()}</p>
                      <p>✓ Emergency services contacted: 911</p>
                      <p>✓ Refuge House notification: Required</p>
                      <p>✓ TBRI interventions documented</p>
                      <p>✓ Incident report due: Within 24 hours</p>
                    </div>
                  </div>
                </div>
