...
import CQICycle from "@/components/substance-use-cqi-cycle-diagram"
import { PDFExportButton } from "@/components/pdf-export-button"

export default function SubstanceUseCQIModelPage() {
      ...
      <div className="bg-gradient-to-r from-[#5E3989] to-[#A90533] text-white">
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <PDFExportButton
              formTitle="Substance Use CQI Model"
              formPath="/forms/substance-use-cqi-model"
